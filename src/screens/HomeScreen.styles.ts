...
const styles = StyleSheet.create({
  ...
  analysisTrendSegment: {
    position: 'absolute',
    height: 3,
    borderRadius: 999,
  },
  analysisTrendSegmentOne: {
    left: 0,
    bottom: 5,
    width: 24,
    transform: [{ rotate: '22deg' }],
  },
  analysisTrendSegmentTwo: {
    left: 20,
    bottom: 9,
    width: 28,
    transform: [{ rotate: '-10deg' }],
  },
  analysisTrendSegmentThree: {
    left: 46,
    bottom: 12,
    width: 24,
  ...
  todayExerciseTitleWrap: {
    flex: 1,
    minWidth: 0,
  },
  todayExerciseTitleMeta: {
    color: TREASY_DARK_TEXT.metadata,
    fontSize: TREASY_TYPE_SCALE.t6.size,
    lineHeight: TREASY_TYPE_SCALE.t6.lineHeight,
    fontWeight: '600',
